    ...
    <footer className="footer ">
      <div className="container">
        <div className="row ">
          <div className="col-xl-4 col-lg-6 col-md-12 col-12">
            <div>
              ...
              <p className="f-des">
                The platform aims to address the issue of high healthcare costs and limited access to care for elderly patients. 
                Also, to make medical costs and medication more manageable for geriatric patients by offering a full range of facilities, 
                including managing diet, yoga wellness, major minor surgeries, counseling from experts, and developing a design of a pill management box
              </p>
              <span className="pb-2 d-inline-block">Contact Us</span>
              <h3 className="">+353 899757172</h3>
            </div>
          </div>
        ...
        <code className="text-center d-block">
          Copyright © 2022 Design & Developed by Darshan
        </code>
      </div>
    </footer>
  );
